...
import static com.progressoft.jfw.annotations.processor.test.ProcessorAssert.assertProcessing;

public class CopierAnnotationProcessorTest {

    private static final String BASE_PACKAGE = "com/progressoft/jfw/annotations/processor/copier/";
